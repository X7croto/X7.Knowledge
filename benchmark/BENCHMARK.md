...
1. Rodar o benchmark contra a Base anterior → `mediana_antes`, `cobertura_antes`
2. Rodar contra a Base nova → `mediana_depois`, `cobertura_depois`
3. **Bloqueia a conclusão** se `mediana_depois > mediana_antes` (MT-02)
4. Registrar ambos no fechamento da capacidade
